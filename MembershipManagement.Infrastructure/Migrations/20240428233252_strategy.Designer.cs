...
namespace MembershipManagement.Infrastructure.Migrations
{
    ...
    [Migration("20240428233252_strategy")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MembershipManagement.Domain.Entities.Branch", b =>
                {
                    b.Property<int>("BranchID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MembershipManagement.Domain.Entities.Sealing", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AppliedByDate = new DateTime(2024, 4, 29, 1, 32, 52, 384, DateTimeKind.Local).AddTicks(7789),
                            BranchId = 3,
                        ...
                        new
                        {
                            ...
                            AppliedByDate = new DateTime(2024, 4, 29, 1, 32, 52, 384, DateTimeKind.Local).AddTicks(7807),
                            BranchId = 3,
                            SealingDate = new DateTime(2024, 5, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            SealingId = 2,
                            SealingType = "Regular",
                        ...
                        new
                        {
                            ...
                            AppliedByDate = new DateTime(2024, 4, 29, 1, 32, 52, 384, DateTimeKind.Local).AddTicks(7811),
                            BranchId = 3,
                        ...
                        new
                        {
                            ...
                            AppliedByDate = new DateTime(2024, 4, 29, 1, 32, 52, 384, DateTimeKind.Local).AddTicks(7814),
                            BranchId = 3,
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MembershipManagement.Domain.Entities.ApplicationUser", null)
                        .WithMany()
